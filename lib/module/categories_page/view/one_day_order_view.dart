...
class OneDayOrderView extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('asset/one_day_order.png'), // Gambar
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              SizedBox(height: 16),
              Text(
                "Dirancang untuk memenuhi kebutuhan Anda yang sibuk, kami menawarkan pembersihan menyeluruh dalam sehari, tanpa mengorbankan kualitas.",
                style: TextStyle(
                  fontSize: 14,
