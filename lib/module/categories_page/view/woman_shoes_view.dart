...
class WomanShoesView extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('asset/woman_shoes.png'), // Gambar
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              SizedBox(height: 16),
              Text(
                "Kami menawarkan layanan pembersihan sepatu wanita yang dirancang untuk mengembalikan keindahan dan keanggunan sepatu Anda.",
                style: TextStyle(
                  fontSize: 14,
