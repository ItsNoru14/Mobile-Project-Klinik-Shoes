...
class LeatherCleaningView extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('asset/leather_cleaning.png'), // Gambar
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              SizedBox(height: 16),
              Text(
                "Dengan teknik pembersihan yang lembut dan produk khusus untuk kulit, kami membersihkan setiap noda dan debu, mengembalikan kilau sepatu Anda tanpa merusak bahan.",
                style: TextStyle(
                  fontSize: 14,
