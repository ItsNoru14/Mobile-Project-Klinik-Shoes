...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final EditProfileController controller = getX.Get.put(EditProfileController());
              ...
              return Column(
                children: [
                  Container(
                    ...
                    child: CircleAvatar(
                      radius: 50,
                      backgroundImage: controller.profile['photoPath']?.value.isNotEmpty ?? false
                          ? FileImage(File(controller.profile['photoPath']!.value))
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        trailing: Icon(Icons.arrow_forward_ios),
                        onTap: () {
                          getX.Get.to(WebViewPage(url: 'https://www.instagram.com/klinik__shoes?igsh=M3RvZjFmYmwxbmkz'));
                        },
                      ),
                    ],
                  ),
