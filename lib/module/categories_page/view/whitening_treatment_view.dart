...
class WhiteningTreatmentView extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('asset/whitening_shoes.png'), // Gambar
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              SizedBox(height: 16),
              Text(
                "Layanan whitening treatment kami dirancang khusus untuk mengembalikan kecerahan dan kesegaran sepatu Anda yang mulai pudar.",
                style: TextStyle(
                  fontSize: 14,
